...
#     # Sample data
#     extracted_skills = ["python", "data analysis", "sql", "machine learning"]
#     top_5 = [
#         ("Data Scientist", "Technology", 0.85),
#         ("Data Analyst", "Finance", 0.80),
#         ("Machine Learning Engineer", "Healthcare", 0.75),
#         ("Business Intelligence Developer", "Retail", 0.70),
#         ("Research Scientist", "Academia", 0.65)
#     ]
#     gap_info_list = [
#         ({"python", "data analysis"}, {"python", "data analysis", "deep learning"}, {"deep learning"}),
#         ({"python", "sql"}, {"python", "sql", "tableau", "excel"}, {"tableau", "excel"}),
#         ({"python", "machine learning"}, {"python", "machine learning", "tensorflow", "keras"}, {"tensorflow", "keras"})
#     ]
    
#     generate_pdf_report("skillfit_report.pdf", extracted_skills, top_5, gap_info_list)